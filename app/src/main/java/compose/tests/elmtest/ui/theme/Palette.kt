...
object LightPalette {
    ...
    val gray_500 = Color(0xFF828282)
    val gray_700 = Color(0xFF222222)

    val blue_700 = Color(0xFF3960AC)
    val green_700 = Color(0xFF298E52)
    val red_700 = Color(0xFFB72C2C)
}

object DarkPalette {
    val gray_300 = Color(0xFFE5E5E5)
    val gray_500 = Color(0xFF828282)
